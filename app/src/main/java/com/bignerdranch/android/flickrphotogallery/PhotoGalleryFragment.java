...
//        setRetainInstance(true);
    ...
    private void setupAdapter() {
        ...
        //FIXME isAdded call no longer necessary since setupAdapter isn't being called
        //in a AsyncTask callback and since setRetainInstance ==false now
        if (isAdded()) {

            mAdapter = new PhotoAdapter();

            mModelView.getGalleryItemsList().observe(this,
